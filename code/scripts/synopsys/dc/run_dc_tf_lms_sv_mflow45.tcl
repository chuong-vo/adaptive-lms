...
set out_dir  [file join $project_root artifacts dc out mflow45]
set rpt_dir  [file join $project_root artifacts dc reports mflow45]
set work_dir [file join $project_root artifacts dc work mflow45]

set_app_var search_path [list \
    [file join $project_root src sv rtl] \
    [file join $project_root constraints] \
    $pdk_root \
]
...
analyze -format sverilog [file join $project_root src sv rtl adaptation_lms.sv]
elaborate $top_name
current_design $top_name
link
check_design

source [file join $project_root constraints tf_lms_sv.sdc]
uniquify
compile_ultra
