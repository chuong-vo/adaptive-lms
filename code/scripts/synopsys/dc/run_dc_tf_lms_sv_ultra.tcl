...
set out_dir  [file join $project_root artifacts dc out ultra]
set rpt_dir  [file join $project_root artifacts dc reports ultra]
set work_dir [file join $project_root artifacts dc work ultra]
