...
set out_dir  [file join $project_root artifacts dc out default]
set rpt_dir  [file join $project_root artifacts dc reports default]
set work_dir [file join $project_root artifacts dc work default]
