...
set out_dir  [file join $project_root artifacts dc out compile]
set rpt_dir  [file join $project_root artifacts dc reports compile]
set work_dir [file join $project_root artifacts dc work compile]
