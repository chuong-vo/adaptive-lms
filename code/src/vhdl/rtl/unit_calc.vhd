...
architecture standard of unit_calc is
	...
	signal shiftx: std_logic_vector(31 downto 0) := (others => '0');
	signal shiftxn: std_logic_vector(31 downto 0) := (others => '0');
	signal shiftue: std_logic_vector(23 downto 0) := (others => '0');
	signal shifty: std_logic_vector(15 downto 0) := (others => '0');

     signal coeff8: std_logic_vector(7 downto 0) := (others => '0');
	signal coeff16:std_logic_vector(15 downto 0) := (others => '0');
	signal xnin_ue:std_logic_vector(15 downto 0) := (others => '0');
	signal xnin_ue_scaled:std_logic_vector(15 downto 0) := (others => '0');
	signal new_coeff_true:std_logic_vector(15 downto 0) := (others => '0');
	signal delayed_new_coeff_true:std_logic_vector(15 downto 0) := (others => '0');
	signal y_out16:std_logic_vector(15 downto 0) := (others => '0');
	signal y_out8:std_logic_vector(7 downto 0) := (others => '0');
begin
	-- basic pipelining 
	unit_process:
	process (clock)
