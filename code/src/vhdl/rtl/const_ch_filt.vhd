...
architecture structural of const_ch_filt is
	...
	signal t_data_out1: std_logic_vector (7 downto 0) := (others => '0');
	signal t_data_out2: std_logic_vector (7 downto 0) := (others => '0');
	signal t_res_out1: std_logic_vector (7 downto 0) := (others => '0');
	signal t_res_out2: std_logic_vector (7 downto 0) := (others => '0');
